...
;(function ($, window, undefined)
{
    ...
    {
        var request = {
                skipCount: (this.current-1) * this.rowCount,
                maxResultCount: this.rowCount,
                sort: this.sort,
    ...
    */
        ...
        if (this.options.ajax)
        {
            ...
            that.xqr = $.ajax({
                ...
                success: function (response) {
                    ...
                    that.current = response.result.pageIndex;
                    update(response.result.items, response.result.totalCount);
                },
    ...
    function renderPaginationItem(list, uri, text, markerCss)
    {
        var that = this,
            tpl = this.options.templates,
            css = this.options.css,
            values = getParams.call(this, { css: markerCss, text: text, uri:"", click: text }),
    ...
    Grid.defaults = {
        ...
        templates: {
            ...
            paginationItem: "<li class=\"{{ctx.css}}\"><a href=\"{{ctx.uri}}\" ng-click=\"vm.loadData({{ctx.click}})\" class=\"{{css.paginationButton}}\">{{ctx.text}}</a></li>",
