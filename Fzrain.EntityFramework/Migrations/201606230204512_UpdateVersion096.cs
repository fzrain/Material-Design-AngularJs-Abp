namespace Fzrain.Migrations
{
    ...
    public partial class UpdateVersion096 : DbMigration
    {
        public override void Up()
        {
            DropForeignKey("dbo.Settings", "TenantId", "dbo.Tenants");
            ...
            DropIndex("dbo.Settings", new[] { "TenantId" });
            ...
            AddColumn("dbo.UserLogins", "TenantId", c => c.Int());
            AddColumn("dbo.Permissions", "TenantId", c => c.Int());
            AddColumn("dbo.UserRoles", "TenantId", c => c.Int());
            AddColumn("dbo.Tenants", "ConnectionString", c => c.String(maxLength: 1024));
            AddColumn("dbo.UserNotifications", "TenantId", c => c.Int());
            AddColumn("dbo.UserNotifications", "TenantNotificationId", c => c.Guid(nullable: false));
            DropColumn("dbo.UserNotifications", "NotificationId");
        }
        
        public override void Down()
        {
            AddColumn("dbo.UserNotifications", "NotificationId", c => c.Guid(nullable: false));
            DropColumn("dbo.UserNotifications", "TenantNotificationId");
            DropColumn("dbo.UserNotifications", "TenantId");
            DropColumn("dbo.Tenants", "ConnectionString");
            DropColumn("dbo.UserRoles", "TenantId");
            DropColumn("dbo.Permissions", "TenantId");
            DropColumn("dbo.UserLogins", "TenantId");
            AlterTableAnnotations(
                "dbo.UserNotifications",
                c => new
                    {
            ...
            CreateIndex("dbo.Roles", "TenantId");
            CreateIndex("dbo.Settings", "TenantId");
            CreateIndex("dbo.Users", "TenantId");
            AddForeignKey("dbo.Roles", "TenantId", "dbo.Tenants", "Id");
            AddForeignKey("dbo.Users", "TenantId", "dbo.Tenants", "Id");
            AddForeignKey("dbo.Settings", "TenantId", "dbo.Tenants", "Id");
        }
    }
}
